...
userRouter.delete("/", authorization.securedPath, validators.userDeleteValidationRules, validators.validate, userServices.deleteUser);
userRouter.post("/login", validators.userLoginValidationRules, validators.validate, userServices.loginUser);
userRouter.post("/info", authorization.securedPath, userServices.userInfo);
userRouter.post("/logout", authorization.securedPath, userServices.userLogout);
